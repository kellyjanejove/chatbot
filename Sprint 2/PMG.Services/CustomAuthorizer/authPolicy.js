(function () {
     ...
     * }
     *
     * var testPolicy = new AuthPolicy("[principal user identifier]", "[Client ID]", "[AWS account id]", apiOptions);
     ...
     * @constructor
     */
    function AuthPolicy(principal, clientId, awsAccountId, apiOptions) {
        /**
        ...
        /**
         * The Client ID used for generated the security token.
         *
         * @property clientId
         * @type {String}
         */
    ...
    AuthPolicy.prototype = (function () {
         ...
         *
         * @method addMethod
         * @param {String} effect for the policy. This can only be "Allow" or "Deny".
         * @param {String} verb for the HTTP method, this should ideally come from the
         *                 AuthPolicy.HttpVerb object to avoid spelling mistakes
         * @param {String} resource path. For example "/pets"
        ...
        var addMethod = function (effect, verb, resource, conditions) {
            ...
            if (!this.pathRegex.test(resource)) {
                throw new Error('Invalid resource path: ' +
                    resource + '. Path should match ' + this.pathRegex);
            }
        ...
        var getStatementsForEffect = function (effect, methods) {
            ...
            if (!isEmpty(methods)) {
                ...
                for (var i = 0; i < methods.length; i++) {
                    ...
                    if (isEmpty(curMethod.conditions)) {
        ...
        return {
             ...
             */
            build: function () {
                if (isEmpty(this.allowMethods) && isEmpty(this.denyMethods)) {
                    throw new Error('No statements defined for the policy');
                }

                let policyDocumentStatements = [];
                policyDocumentStatements = policyDocumentStatements.concat(
